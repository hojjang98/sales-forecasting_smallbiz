...
sales-forecasting-smallbiz/ ├── data/ # Raw & processed data │ ├── raw/ │ └── processed/ ├── notebooks/ # Jupyter notebooks │ ├── 01_eda.ipynb │ └── 02_modeling.ipynb ├── src/ # Custom functions │ └── utils.py ├── app/ # Optional Streamlit dashboard │ └── streamlit_app.py ├── reports/ # Charts & figures │ └── figures/ └── README.md
